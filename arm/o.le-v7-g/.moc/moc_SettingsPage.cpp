...
static const char qt_meta_stringdata_SettingsPage[] = {
    "SettingsPage\0\0introMessageChanged(bool)\0"
    "supportMessageChanged(bool)\0"
};
...
void SettingsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->introMessageChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->supportMessageChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void SettingsPage::introMessageChanged(bool _t1)
{
...
// SIGNAL 1
void SettingsPage::supportMessageChanged(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
